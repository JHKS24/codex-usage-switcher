...
# required on the target machine). Output: build/win-x64/CodexUsageSwitcher.Windows.exe
#
...
$root = $PSScriptRoot
$project = Join-Path $root 'windows/CodexUsageSwitcher.Windows/CodexUsageSwitcher.Windows.csproj'
...
$exe = Join-Path $output 'CodexUsageSwitcher.Windows.exe'
